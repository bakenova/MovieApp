...
var playlistArtist: [ArtistPlaylist] = [
    ArtistPlaylist(
        ...
        songs: [
            Song(name: "My Universe", artist: "Kairat Nurtas", imageName: "MyUniverse", releaseDate: "2021", album: "My Universe", duration: 185)
        ],
        releaseDate: "2019",
        genre: "Pop",
    ...
    ArtistPlaylist(
        ...
        songs: [
            Song(name: "Моя любов", artist: "Akha", imageName: "Моя любовь", releaseDate: "2021", album: "Моя любовь", duration: 185)
        ],
        releaseDate: "2022",
        genre: "Pop",
